...
add_action( 'wp_enqueue_scripts', function () {
	...
	// Custom CSS
	wp_add_inline_style( 'reading-mode', $custom_css );

	Dracula_Enqueue::instance()->frontend_scripts( null, $is_reading_mode = true );
	wp_enqueue_script( 'reading-mode', DRACULA_ASSETS . '/js/reading-mode.js', [ 'wp-components','dracula-frontend' ], DRACULA_VERSION, true );
